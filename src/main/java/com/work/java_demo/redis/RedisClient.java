package com.work.java_demo.redis;
 ...
 * 
 * 注意：
 * 注释掉redis.conf的bind 127.0.0.1
 * 关闭保护模式 protected-mode no
 * @author：ancel.wang
 * @creattime：2018年5月3日 下午7:06:42 
 * 
 */  
public class RedisClient {
	...
	private String redisHostName = "172.18.19.82";
	...
	private void initialPool() {
		...
		jedisPool = new JedisPool(config, redisHostName, 6379);
	}
	...
	private void initialShardedPool() {
		...
		shards.add(new JedisShardInfo(redisHostName, 6379, "master"));
